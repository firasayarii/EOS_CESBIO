...
intervals = [
    np.linspace(0.4, 0.7, 300, dtype=np.float32),
...
#lamda_values=[0.4,0.45,0.5,0.55,0.6,0.65]
batches=[]
batches.append(lamda_values[0:100])
batches.append(lamda_values[100:200])
batches.append(lamda_values[200:300])
...
def run_batch(lambdas, batch_id):
    ...
    for i in range(2):
        ...
        K_aero = K_aerosol()
        reflectance = (0.15 * np.random.rand(l) + 0.85).tolist()
